...
void loop() {
  ...
  if ((mpuIntStatus & 0x10) || fifoCount == 1024) {
    ...
    //Serial1.print("Acceleration_x: ");
    //Serial1.println(int(aaReal.x));
    Serial.write(int(aaReal.x) >> 8);
    Serial.write(int(aaReal.x));
    //Serial1.print("Acceleration_y: ");
    //Serial1.println(int(aaReal.y));
    Serial.write(int(aaReal.y) >> 8);
    Serial.write(int(aaReal.y));
    //Serial1.print("Acceleration_z: ");
    //Serial1.println(int(aaReal.z));
    ...
    for (int i = 0; i < 7; i++) {
      ...
      //Serial1.print(i);
      //Serial1.print(" : ");
      //Serial1.println(byte(UltrasonicRange[i]));
      Serial.write(byte(UltrasonicRange[i]));
    }
    //Packet 2 indicator
    //Serial1.println("Second package");
    Serial.write(byte(2));
    //Serial1.print("Ultrasonic 7 : ");
    //Serial1.println(byte(UltrasonicRange[7]));
    Serial.write(byte(UltrasonicRange[7]));
    //Output PIR value
    //Serial1.print("PIR sensor data: ");
    //Serial1.print(byte(PIR_1));
    //Serial1.println(byte(PIR_2));
    
    Serial.write(byte(PIR_1));
    Serial.write(byte(PIR_2));

    //Output environment value
    //Serial1.print("Humidity and temperature: ");
    //Serial1.print( byte(humidity));
    //Serial1.println(byte(temperature));
